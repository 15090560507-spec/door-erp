...
function FlowInfo({ label, value }: { label: string; value: string }) { return <div className="min-w-0"><span className="block text-[#8E8E93]">{label}</span><span className="mt-0.5 block truncate text-[#3A3A3C]" title={value}>{value}</span></div>; }
