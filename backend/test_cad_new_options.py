...
def test_pillar_handle_title_and_three_column_panel():
    ...
    check(
        "covered panel areas use wipeout masks",
        len(wipeouts) >= 1 and all(entity.dxf.layer == "A-DOOR-MASK" for entity in wipeouts),
        [(entity.dxftype(), entity.dxf.layer) for entity in wipeouts[:5]],
    )
