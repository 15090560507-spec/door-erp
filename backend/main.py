...
def build_cad_params(req: CADRequest):
    ...
    info_map = {
        ...
        "QC_GLASS_STYLE": req.qc_glass_style,
        ...
        "PANEL_PRESET": req.panel_preset,
        "DOOR_PANEL_STYLE": req.door_panel_style,
        "BACK_PANEL_SAME_AS_FRONT": req.back_panel_same_as_front,
        "BACK_DOOR_PANEL_STYLE": req.back_door_panel_style,
        "CHILD_DOOR_PANEL_STYLE": req.child_door_panel_style,
        "CHILD_BACK_SAME_AS_FRONT": req.child_back_same_as_front,
        "CHILD_BACK_DOOR_PANEL_STYLE": req.child_back_door_panel_style,
        ...
        "BACK_PANEL_FILL_A": req.back_panel_fill_a,
        ...
        "BACK_PANEL_BORDER_INSET": req.back_panel_border_inset,
        "BACK_PANEL_THREE_SIDE_LOCK_OFFSET": req.back_panel_three_side_lock_offset,
        "BACK_PANEL_THREE_SIDE_INSET": req.back_panel_three_side_inset,
        ...
        "CHILD_PANEL_FILL_A": req.child_panel_fill_a,
        ...
        "CHILD_PANEL_BORDER_INSET": req.child_panel_border_inset,
        "CHILD_PANEL_THREE_SIDE_LOCK_OFFSET": req.child_panel_three_side_lock_offset,
        "CHILD_PANEL_THREE_SIDE_INSET": req.child_panel_three_side_inset,
        "CHILD_PANEL_B2_GLASS_STYLE": req.child_panel_b2_glass_style,
        "CHILD_PANEL_B4_GLASS_STYLE": req.child_panel_b4_glass_style,
        "CHILD_GLASS_LINE_INSET": req.child_glass_line_inset,
        "CHILD_GLASS_LINE_SPACING": req.child_glass_line_spacing,
        "CHILD_BACK_PANEL_LOCK_OFFSET_X": req.child_back_panel_lock_offset_x,
        "CHILD_BACK_PANEL_HINGE_OFFSET_Y": req.child_back_panel_hinge_offset_y,
        "CHILD_BACK_PANEL_MIDDLE_OFFSET_Z": req.child_back_panel_middle_offset_z,
        "CHILD_BACK_PANEL_PLUS_OFFSET_A": req.child_back_panel_plus_offset_a,
        "CHILD_BACK_PANEL_PLUS_OFFSET_B": req.child_back_panel_plus_offset_b,
        "CHILD_BACK_PANEL_THREE_COL_A": req.child_back_panel_three_col_a,
        "CHILD_BACK_PANEL_THREE_COL_B": req.child_back_panel_three_col_b,
        "CHILD_BACK_PANEL_THREE_COL_C": req.child_back_panel_three_col_c,
        "CHILD_BACK_PANEL_FILL_A": req.child_back_panel_fill_a,
        "CHILD_BACK_PANEL_FILL_B": req.child_back_panel_fill_b,
        "CHILD_BACK_PANEL_FILL_C": req.child_back_panel_fill_c,
        "CHILD_BACK_PANEL_DISC_RADIUS": req.child_back_panel_disc_radius,
        "CHILD_BACK_PANEL_BORDER_INSET": req.child_back_panel_border_inset,
        "CHILD_BACK_PANEL_THREE_SIDE_LOCK_OFFSET": req.child_back_panel_three_side_lock_offset,
        "CHILD_BACK_PANEL_THREE_SIDE_INSET": req.child_back_panel_three_side_inset,
        "CHILD_BACK_PANEL_B2_GLASS_STYLE": req.child_back_panel_b2_glass_style,
        "CHILD_BACK_PANEL_B4_GLASS_STYLE": req.child_back_panel_b4_glass_style,
        "CHILD_BACK_GLASS_LINE_INSET": req.child_back_glass_line_inset,
        "CHILD_BACK_GLASS_LINE_SPACING": req.child_back_glass_line_spacing,
    ...
    draw_params = {
        ...
        "child_back_panel_three_side_lock_offset": req.child_back_panel_three_side_lock_offset,
        "child_back_panel_three_side_inset": req.child_back_panel_three_side_inset,
        "child_back_panel_horizontal_a_height": req.child_back_panel_horizontal_a_height,
        "child_back_panel_horizontal_b_height": req.child_back_panel_horizontal_b_height,
        "child_back_panel_b2_glass_style": req.child_back_panel_b2_glass_style,
        "child_back_panel_b4_glass_style": req.child_back_panel_b4_glass_style,
        "child_back_glass_line_inset": req.child_back_glass_line_inset,
        "child_back_glass_line_spacing": req.child_back_glass_line_spacing,
