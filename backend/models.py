...
class CADRequest(BaseModel):
    ...
    outer_landscape_left_width: float = 160  # 一门一景左景宽
    outer_landscape_right_width: float = 160 # 一门一景右景宽
    outer_landscape_top_height: float = 160  # 一门一景上景高
    outer_landscape_left_overlap: float = 20 # 一门一景左景压框
    outer_landscape_right_overlap: float = 20 # 一门一景右景压框
    outer_landscape_top_overlap: float = 20  # 一门一景上景压框
    ...
    qc_glass_style: str = "无线条"       # 矩形玻璃气窗线条样式
